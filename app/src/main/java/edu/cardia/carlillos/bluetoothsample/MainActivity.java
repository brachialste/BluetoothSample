...
import edu.cardia.carlillos.bluetoothsample.utils.AndroidIdentifier;
...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Sends a message.
     * @param send  A byte[] of text to send.
     */
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_STATE_CHANGE:
                    ...
                    break;
                case MESSAGE_WRITE:
                    if(D) Log.i(TAG, "MESSAGE_WRITE: " + new String((byte[]) msg.obj));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_CONNECT_DEVICE:
                if(D) Log.i(TAG, "REQUEST_CONNECT_DEVICE");
            ...
            case REQUEST_ENABLE_BT:
                if(D) Log.i(TAG, "REQUEST_ENABLE_BT");
